...
const file_takv_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"takv.proto\x12\x0fgoatak.cotproto\"d\n" +
	"\x04Takv\x12\x16\n" +
	"\x06device\x18\x01 \x01(\tR\x06device\x12\x1a\n" +
	"\bplatform\x18\x02 \x01(\tR\bplatform\x12\x0e\n" +
	"\x02os\x18\x03 \x01(\tR\x02os\x12\x18\n" +
	"\aversion\x18\x04 \x01(\tR\aversionB&H\x03Z\"github.com/kdudkov/goatak/cotprotob\x06proto3"
...
var file_takv_proto_goTypes = []any{
	(*Takv)(nil), // 0: goatak.cotproto.Takv
}
